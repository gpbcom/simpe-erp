...
class InterventionRow(Base):
    ...
    Notes:
        ...
        - ``(company_id, day)`` is the one the planner needs. Replacing a period's
          plan deletes every row in it, and that delete has to name an agency or
    ...
    __table_args__ = (
        ...
        Index("ix_interventions_company_day", "company_id", "day"),
