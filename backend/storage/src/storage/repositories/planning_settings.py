...
from storage.mappers.planning_settings_mapper import PlanningSettingsMapper
from storage.orm.planning_settings_row import PlanningSettingsRow
...
class PlanningSettingsRepository(BaseRepository[PlanningSettingsRow]):
    ...
    def __init__(self, session: AsyncSession, logger: Optional[Logger] = None) -> None:
        ...
        self.mapper = PlanningSettingsMapper(logger=resolved_logger)
