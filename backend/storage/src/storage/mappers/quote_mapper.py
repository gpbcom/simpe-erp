...
class QuoteMapper(BaseMapper[Quote, QuoteRow]):
    ...
    def _aggregate_to_model(self, row: QuoteAggregateRow) -> QuoteTypeWeekAggregate:  # noqa: E501
    ...
    def _line_rows(self, quote_id: str, lines: List[QuoteLine]) -> List[QuoteLineRow]:  # noqa: E501
    ...
    def _build_model(self, row: QuoteRow) -> Quote:
        ...
        return Quote(
            ...
            aggregates=[self._aggregate_to_model(entry) for entry in row.aggregates],  # noqa: E501
