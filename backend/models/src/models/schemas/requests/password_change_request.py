...
class PasswordChangeRequest(BaseModel):
    ...
    def validate_current_password(cls, value: Union[str, None]) -> str:
        """Validates that the current password was supplied.

        Args:
            value (Union[str, None]): Raw ``current_password`` value.
    ...
    def validate_new_password(cls, value: Union[str, None]) -> str:
        """Validates that the new password meets the policy.

        Args:
            value (Union[str, None]): Raw ``new_password`` value.
