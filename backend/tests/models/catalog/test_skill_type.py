...
class TestSkillType:
    ...
    def test_hyphens_and_underscores_are_allowed(
        self, valid_kwargs: Dict[str, Any], separator: str
    ) -> None:
    ...
    def test_an_accented_code_is_refused(self, valid_kwargs: Dict[str, Any]) -> None:
    ...
    def test_a_malformed_code_is_refused(
        self, valid_kwargs: Dict[str, Any], code: object
    ) -> None:
    ...
    def test_a_blank_label_is_refused(
        self, valid_kwargs: Dict[str, Any], label: object
    ) -> None:
    ...
    def test_a_non_boolean_is_active_is_refused(
        self, valid_kwargs: Dict[str, Any], value: object
    ) -> None:
    ...
    def test_an_absent_id_is_allowed(self, valid_kwargs: Dict[str, Any]) -> None:
    ...
    def test_a_blank_id_is_refused(
        self, valid_kwargs: Dict[str, Any], identifier: object
    ) -> None:
    ...
    def test_a_dumped_entry_round_trips(self, valid_kwargs: Dict[str, Any]) -> None:
